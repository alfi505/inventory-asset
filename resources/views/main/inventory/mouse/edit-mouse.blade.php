        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item active" aria-current="page">Edit Mouse</div>
                </div>
            </div>

            <form action="{{ url('/inventory-mouse') . '/' . str_replace('/', '_', $data->id_mouse) }}" method="post">
                @csrf
                @method('PUT')
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group col">
                            ...
                            <input type="text" class="form-control" name="id_mouse" value="{{ $data->id_mouse }}"
                                readonly>
                        </div>
                        <div class="row">
                            <div class="form-group col">
                            ...
                            <div class="form-group col">
                                <label>Model Mouse</label>
                                <input type="text" class="form-control" name="model_mouse" id="model_mouse" readonly
                                    value="{{ $data->model_mouse }}">
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="status_id" id="status_id">
                                @foreach ($status as $statuses)
                                    <option value="{{ $statuses->id }}" @if ($statuses->id == $mouses->status_id) selected @endif>
...
@push('scripts')
    ...
    {{-- <script>
        ...
        const InputIdEl = document.querySelector('#id_mouse')
