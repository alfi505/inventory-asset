        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item active" aria-current="page">Tambah Printer</div>
                </div>
            </div>

            <form action="{{ url('/inventory-printer') }}" method="post">
                @csrf
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="form-group col">
                                ...
                                <input type="text" class="form-control" name="model_printer" id="model_printer" required>
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col">
