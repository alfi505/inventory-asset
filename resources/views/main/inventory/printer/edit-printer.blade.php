        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item active" aria-current="page">Edit printer</div>
                </div>
            </div>

            <form action="{{ url('/inventory-printer') . '/' . str_replace('/', '_', $data->id_printer) }}" method="post">
                @csrf
                @method('PUT')
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group col">
                            ...
                            <input type="text" class="form-control" name="id_printer" value="{{ $data->id_printer }}"
                                readonly>
                        </div>
                        <div class="row">
                            <div class="form-group col">
                            ...
                            <div class="form-group col">
                                ...
                                <input type="text" class="form-control" name="model_printer" id="model_printer" readonly
                                    value="{{ $data->model_printer }}">
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="status_id" id="status_id">
                                @foreach ($status as $statuses)
                                    <option value="{{ $statuses->id }}" @if ($statuses->id == $printers->status_id) selected @endif>
...
@push('scripts')
    ...
    {{-- <script>
        ...
        const InputIdEl = document.querySelector('#id_printer')
