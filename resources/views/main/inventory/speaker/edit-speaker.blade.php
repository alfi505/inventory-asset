        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item active" aria-current="page">Edit Speaker</div>
                </div>
            </div>

            <form action="{{ url('/inventory-speaker') . '/' . str_replace('/', '_', $data->id_speaker) }}" method="post">
                @csrf
                @method('PUT')
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group col">
                            ...
                            <input type="text" class="form-control" name="id_speaker" value="{{ $data->id_speaker }}"
                                readonly>
                        </div>
                        <div class="row">
                            <div class="form-group col">
                            ...
                            <div class="form-group col">
                                ...
                                <input type="text" class="form-control" name="model_speaker" id="model_speaker" readonly
                                    value="{{ $data->model_speaker }}">
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="status_id" id="status_id">
                                @foreach ($status as $statuses)
                                    <option value="{{ $statuses->id }}" @if ($statuses->id == $speakers->status_id) selected @endif>
